       ...
       <section>
           <c:if test="${requestScope.info!=null}">
               <c:choose>
                   ...
                   <c:if test="${an!=null}">
                       <h1><c:out value="${an.title}"></c:out></h1>
                       <div>
           ...
           <p></p>
                                           <div class="cadre2">
                                               <div class="info">Aucune annonce dans cette catégorie.</div>
                                           </div>
                                           <br/>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
                                                         ...
                                                         <div class="listeAnnonce2" onclick="javascript:window.location.href='${an.urls[i]}#annonce';">
                                                              <div class="listeAnnonceGauche">
                                                                  <c:if test="${empty an.extensions[i]}">
                                                                      <img src="./GFXs/miniature.png" width="100" height="100" alt="miniature"/>
                                                                  </c:if>
                                                                  <c:if test="${not empty an.extensions[i]}">
                                                                      <img src="<c:out value="./photo-mini-1-1-${an.ids[i]}-${an.indexs[i]}${an.extensions[i]}"></c:out>" width="<c:out value="${an.largeurs[i]}"></c:out>" height="<c:out value="${hauteurs[i]}"></c:out>" alt="miniature"/>
                                                                  </c:if>
                                                              </div>
                                                              <div class="listeAnnonceDroite">
                                                                  <h1>
                                                                      <a href="${an.urls[i]}#annonce" titme="<c:out value="${an.titres[i]}"></c:out>"><c:out value="${an.titres[i]}"></c:out></a>
                                                                  </h1>
                                                                  <p>
                                                                  ${an.lignes1[i]}
                                                                  <br/>
                                                          ...
                                                          <div class="pages">
                                                              ...
                                                              <c:forEach var="i" begin="${an.prem}" end="${an.der}" step="1">
                                                                  ...
                                                                  <c:if test="${an.page!=i}">
                                                                      <span>[<a href="./annonces-cat-${an.idCategorie}-${i}-${an.encodedCat}.html" title="<c:out value="PAGE # ${i+1}"></c:out>"><c:out value="${i+1}"></c:out></a>]</span>
                                                                  </c:if>
                                                              </c:forEach>
                                                          </div>
                                                          <br/>
