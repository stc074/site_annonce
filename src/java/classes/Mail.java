...
public class Mail {
    ...
    public void send() {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("noreply@megannonce.net", "paradize"));
            email.addTo(this.destinataireEmail, this.destinataireNom);
            email.setFrom("noreply@Mmegannonce.net", "Megannonce");
    ...
    public void initMailAnnonce1(String pseudo, String titreAnnonce, String uri, long idAnnonce, int type) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
    ...
    this.contenu+="<br/>";
    this.contenu+="<div>Vous pourrez l'éditer à cette adresse : <a href=\""+Datas.URLROOT+"/edit-annonce-"+type+"-"+idAnnonce+".html\">"+Datas.URLROOT+"/edit-annonce-"+type+"-"+idAnnonce+".html</a></div>";
    this.contenu+="<br/>";
    this.contenu+="<div><a href=\""+Datas.URLROOT+"\">"+Datas.URLROOT+"</a>";
    this.contenu+="<br/>";
    this.contenu+="<br/>";
    ...
    public void initMailAnnonceModif1(String pseudo, String titreAnnonce, String uri, long idAnnonce, int type) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
