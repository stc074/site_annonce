 ...
 * @author pj
 */
public class PetiteAnnonceImmobiliere extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(request.getParameter("idAnnonce")==null)
                ...
                AnnonceImmo annonce=new AnnonceImmo(idAnnonce);
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/petiteannonceimmobiliere.jsp");
