...
import classes.AnnoncePhotoEmploi;
 ...
 * @author pj
 */
public class DeposerAnnonceEmploiPhoto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(idMembre==0)
                ...
                AnnoncePhotoEmploi annonce=new AnnoncePhotoEmploi(membre);
                if(annonce.getMembre().getId()==0)
                    request.setAttribute("info", 1);
                else {
                    if(session.getAttribute("type")==null||session.getAttribute("idAnnonce")==null)
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/deposerannoncephotoemploi.jsp");
