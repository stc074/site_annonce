 ...
 * @author pj
 */
public class PetitesAnnoncesImmobilieres extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RechercheImmo recherche=new RechercheImmo();
            session.setAttribute("uriRetour", "./petites-annonces-immobilieres-1.html");
            recherche.initValues(request);
            recherche.initCondition();
            request.setAttribute("recherche", recherche);
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/annoncesimmobilieres.jsp");
