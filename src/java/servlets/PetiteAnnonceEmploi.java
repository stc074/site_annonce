 ...
 * @author pj
 */
public class PetiteAnnonceEmploi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getParameter("idAnnonce")==null)
                ...
                AnnonceEmploi annonce=new AnnonceEmploi(idAnnonce);
                annonce.initDonneesEmploi(idAnnonce);
                annonce.effaceOlds();
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/petiteannonceemploi.jsp");
