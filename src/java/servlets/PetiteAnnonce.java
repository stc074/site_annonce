 ...
 * @author pj
 */
public class PetiteAnnonce extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(request.getParameter("idAnnonce")==null)
                ...
                AnnonceNormale annonce=new AnnonceNormale();
                annonce.initDonnees(idAnnonce);
                annonce.effaceOlds();
                if(annonce.getId()==0||annonce.getMembre().getId()==0)
                    request.setAttribute("info", 1);
                else {
                    request.setAttribute("annonce", annonce);
                }
            }
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/petiteannonce.jsp");
