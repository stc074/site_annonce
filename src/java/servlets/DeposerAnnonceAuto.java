 ...
 * @author pj
 */
public class DeposerAnnonceAuto extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(idMembre==0)
                ...
                AnnonceAuto annonce=new AnnonceAuto(membre);
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/deposerannonceauto.jsp");
