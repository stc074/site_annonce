 ...
 * @author pj
 */
public class DeposerAnnonceNormale extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(idMembre==0)
                ...
                AnnonceNormale annonce=new AnnonceNormale(membre);
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/deposerannoncenormale.jsp");
